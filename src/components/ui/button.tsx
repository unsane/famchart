  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground shadow-soft hover:shadow-lg hover:-translate-y-0.5",
        gold: "bg-gradient-gold text-accent-foreground shadow-glow hover:shadow-lg hover:-translate-y-0.5",
        success: "bg-gradient-success text-primary-foreground shadow-soft hover:shadow-lg",
        sky: "bg-gradient-sky text-primary-foreground shadow-soft hover:shadow-lg",
        fun: "bg-lavender text-foreground hover:bg-lavender/80 shadow-soft",
      },
      size: {
